...
const siteConfig = {
  // Branding
  name: "GoSite",
  tagline: "Find trusted local businesses, ranked by real reviews",
  description: "GoSite — Find and rank trusted local businesses near you.",
  logo: "⚡", // text or emoji logo mark
  domain: process.env.NEXT_PUBLIC_DOMAIN || "gosite.lol",
  ...
  // Contact
  supportEmail: process.env.SUPPORT_EMAIL || "support@gosite.lol",
};
